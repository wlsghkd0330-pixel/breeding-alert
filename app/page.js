      ...
      <div style={{
        ...
        {!subscribed ? (
          <button onClick={subscribe} disabled={loading} style={{
            ...
            fontSize: '16px', fontWeight: '600', cursor: 'pointer', marginBottom: '12px'
          }}>
          ...
          <>
            <div style={{
              ...
              borderRadius: '12px', padding: '12px', color: '#81c784',
              fontSize: '14px', marginBottom: '12px'
            }}>✅ 알림 구독 중</div>
            <button onClick={testNotify} disabled={loading} style={{
            ...
            <button onClick={async () => {
              ...
              color: 'rgba(255,100,100,0.8)', fontSize: '14px', cursor: 'pointer', marginBottom: '12px'
            }}>알림 해제</button>
          </>
        )}
        {status && (
          <div style={{
            ...
            padding: '16px', color: 'rgba(255,255,255,0.8)',
            fontSize: '13px', whiteSpace: 'pre-line', marginTop: '8px'
          }}>{status}</div>
        )}
      </div>
    </main>
